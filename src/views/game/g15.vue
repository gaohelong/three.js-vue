...
<script>
  ...
  import enImg3 from '@/assets/exhibition/9.jpeg'
  ...
  export default {
    ...
    methods: {
      ...
      initObjects() {
        ...
        /* --- 画墙一般y取高度的1/2 --- */
        this.paintWalls(enImg3, 'befor-wall', 100, 2, 50, 0, 13, 50, 1 / 2, 1) // 前面墙
        this.paintWalls(enImg2, 'after-wall', 100, 2, 50, 0, 13, -50, 1 / 2, 0) // 后面墙
        this.paintWalls(enImg4, 'left-wall', 100, 2, 50, -50, 13, 0, -1 / 2, 0, 1 / 2) // 左面墙
        this.paintWalls(enImg5, 'right-wall', 100, 2, 50, 50, 13, 0, 1 / 2, 0, 1 / 2) // 右面墙
      },
      /**
       *
       */
      ...
      positionMove(type) {
        ...
        if (type === 'r-touchstart') { // 触摸开始
          ...
          raycasterBeginPosition = camera.position // 碰撞检测相机初始位置
